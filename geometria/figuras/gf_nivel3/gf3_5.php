...
if ($result->num_rows == 0) {
    ...
    header("location: gf3_4.php"); // Cambia "leccion_anterior_no_completada.php" por la página a la que quieras redireccionar
    exit;
}
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
          ¿Cuántas figuras diferentes se pueden observar?
        </div>
    ...
    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('4')">Cuatro</button>
            <button class="boton" onclick="verificarRespuesta('6')">Seis</button>
            <button class="boton" onclick="verificarRespuesta('9')">Nueve</button>
        </div>
    </div>
