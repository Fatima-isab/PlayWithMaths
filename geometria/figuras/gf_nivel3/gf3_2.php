...
if ($result->num_rows == 0) {
    ...
    header("location: gf3_1.php"); // Cambia "leccion_anterior_no_completada.php" por la página a la que quieras redireccionar
    exit;
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["respuesta"])) {
    ...
    $respuesta_correcta = 'Sol'; // Definir la respuesta correcta
...
<body>
    <h1>Formas en el mundo real</h1>

    <div class="contenedor">
        <div class="inst">
            En la imágen se pueden observar varias figuras. <br>
            Cada figura tiene su color y su posición, de esta manera logra representar
            un paisaje con elementos que conocemos.
            ¿Qué representa el circulo amarillo?
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/gf_32.jpg" alt="" width="360" height="360">
        </div>
    </div>

    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('Pelota')">Una pelota</button>
            <button class="boton" onclick="verificarRespuesta('Llanta')">Una llanta</button>
            <button class="boton" onclick="verificarRespuesta('Sol')">El sol</button>
        </div>
    </div>

    <div class="botones-container">
    <a href="../gf_nivel3/gf3_1.php">
            <button class="boton boton-anterior">Anterior</button>
        </a>
        <a href="../gf_nivel3/gf3_3.php">
