...
if ($result->num_rows == 0) {
    ...
    header("location: gf3_7.php"); // Cambia "gf1_5.php" por la página a la que quieras redireccionar
    exit;
}
...
<body>
<h2>Formas en el mundo real</h2>

<p></p>

<h1>¡Une la figura con lo que puede representar en un carro!</h1>

<img src="../../../assets/img/gf_38.1.jpg" alt="" draggable="true" ondragstart="drag(event)" id="drag1">
<img src="../../../assets/img/gf_38.2.jpg" alt="" draggable="true" ondragstart="drag(event)" id="drag2">
<img src="../../../assets/img/gf_38.3.jpg" alt="" draggable="true" ondragstart="drag(event)" id="drag3">
