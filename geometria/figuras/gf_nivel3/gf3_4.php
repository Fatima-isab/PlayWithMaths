...
if ($result->num_rows == 0) {
    ...
    header("location: gf3_3.php"); // Cambia "leccion_anterior_no_completada.php" por la página a la que quieras redireccionar
    exit;
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["respuesta"])) {
    ...
    $respuesta_correcta = 'Coche'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
          Ahora en la imagen tenemos varis figuras ordenadas para formar un objeto. <br>
          ¿Qué objeto se está formando?
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/gf_34.jpg" alt="" width="360" height="360">
        </div>
    </div>

    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('Coche')">Coche</button>
            <button class="boton" onclick="verificarRespuesta('Casa')">Casa</button>
            <button class="boton" onclick="verificarRespuesta('Perro')">Perro</button>
        </div>
    </div>
