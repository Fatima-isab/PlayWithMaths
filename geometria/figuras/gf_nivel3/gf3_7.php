...
if ($result->num_rows == 0) {
    ...
    header("location: gf3_6.php"); // Cambia "leccion_anterior_no_completada.php" por la página a la que quieras redireccionar
    exit;
}
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
          En la imagen podemos observar un paisaje.
          Hay un elemento que se esta representando con dos figuras.
          Así podemos deducir que se pueden usar diferentes figuras para representar lo mismo.
          ¿Qué elemento se esta representando con 2 formas?
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/gf_37.jpg" alt="" width="360" height="360">
        </div>
    </div>

    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('1')">El árbol</button>
            <button class="boton" onclick="verificarRespuesta('2')">La casa</button>
            <button class="boton" onclick="verificarRespuesta('3')">El sol</button>
        </div>
    </div>

    <div class="botones-container">
    <a href="../gf_nivel3/gf3_6.php">
