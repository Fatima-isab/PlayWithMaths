...
if ($result->num_rows == 0) {
    ...
    header("location: gf3_8.php"); // Cambia "gf1_5.php" por la página a la que quieras redireccionar
    exit;
}
...
<h1>¡Une la forma con lo que puede representar en una casa!</h1>

<img src="../../../assets/img/gf_39.1.jpg" alt="" draggable="true" ondragstart="drag(event)" id="drag1">
<img src="../../../assets/img/gf_39.2.jpg" alt="" draggable="true" ondragstart="drag(event)" id="drag2">
<img src="../../../assets/img/gf_39.3.jpg" alt="" draggable="true" ondragstart="drag(event)" id="drag3">
