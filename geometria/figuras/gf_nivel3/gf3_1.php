...
if ($result->num_rows == 0) {
    ...
    header("location: ../../../geometria/figuras/gf_nivel1/gf2_9.php");
    exit;
};
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
            Las formas estan presentes siempre en nuestro dia a dia,
            en este nivel vamos a descubrir que siempre estamos rodeados
            de figuras geometrícas, y que puede ser muy divertido darnos 
            cuenta de esto.
        </div>
