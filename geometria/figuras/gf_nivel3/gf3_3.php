...
if ($result->num_rows == 0) {
    ...
    header("location: gf3_2.php"); // Cambia "leccion_anterior_no_completada.php" por la página a la que quieras redireccionar
    exit;
}
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
            ...
            ¿Qué figura se usa para el techo de la casa?
        </div>
    ...
    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('Triangulo')">Triangulo</button>
    ...
    <div class="botones-container">
    <a href="../gf_nivel3/gf3_2.php">
            <button class="boton boton-anterior">Anterior</button>
        </a>
        <a href="../gf_nivel3/gf3_4.php">
