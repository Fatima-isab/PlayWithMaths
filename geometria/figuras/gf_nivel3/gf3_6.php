...
if ($result->num_rows == 0) {
    ...
    header("location: gf3_5.php"); // Cambia "leccion_anterior_no_completada.php" por la página a la que quieras redireccionar
    exit;
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["respuesta"])) {
    ...
    $respuesta_correcta = '44'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
          Tenemos un perro formado con varias formas. <br>
          ¿Qué figuras se estan usando para la cabeza?
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/gf_36.jpg" alt="" width="360" height="360">
        </div>
    </div>

    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('4')">Cuadrado</button>
            <button class="boton" onclick="verificarRespuesta('44')">Rectángulo</button>
            <button class="boton" onclick="verificarRespuesta('3')">Triángulo</button>
        </div>
    </div>
