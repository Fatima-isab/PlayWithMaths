...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $respuesta_correcta = 'Amarillo'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst visible">Por ahora hemos visto lo básico.</div>
        <div class="inst">Aun nos falta identificar varias partes.</div>
        <div class="inst">Observa bien la figura que está en el cuaderno.</div>
        <div class="inst">Vamos a identificar el área del hexágono</div>
        <div class="inst">Pista: El área es cuanto espacio hay dentro</div>
        <div class="inst">¿De qué color es el área de la figura?</div>
    ...
    <div>
        <img class="imgLecc" src="../../../assets/img/gf_25.jpg" alt="" width="360" height="360">
    </div>
