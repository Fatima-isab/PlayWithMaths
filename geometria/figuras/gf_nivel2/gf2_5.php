...
if ($result->num_rows == 0) {
    ...
    header("location: gf2_4.php"); // Cambia "leccion_anterior_no_completada.php" por la página a la que quieras redireccionar
    exit;
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["respuesta"])) {
    ...
    $respuesta_correcta = 'Area'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
            Observa que el pentágono tiene 2 colores. <br>
            Azul y verde. <br>
            ¿Cómo se llama la propiedad de color verde?
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/gf_25.png" alt="" width="360" height="360">
        </div>
    </div>

    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('Lado')">Lado</button>
            <button class="boton" onclick="verificarRespuesta('Area')">Área</button>
            <button class="boton" onclick="verificarRespuesta('Angulo')">Ángulo</button>
        </div>
    </div>
