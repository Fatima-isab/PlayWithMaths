...
<body>
    ...
    <div class="contenedor">
        <div class="inst visible">En en nivel anterior vimos las formas.</div>
        <div class="inst">En este nivel estaremos viendo como se conforman.</div>
        <div class="inst">De que se componen y como estan estructuradas.</div>
        <div class="inst">¡Ha divertirse aprendiendo!</div>
    ...
    <div>
        <img class="imgLecc" id="imgLecc" src="../../../assets/img/gf_21.jpg" width="360" height="360" onclick="cambiarImagen()">
    </div>
