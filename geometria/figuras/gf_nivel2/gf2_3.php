...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
           Las esquinas que tienen las figuras tienen un nombre. <br>
           Esas esquinas se pueden medir. <br>
           Tanto por fuera como por dentro de la figura. <br>
           En la imagen se muestra la medida de la esquina por dentro. <br>
           A esta medida se le llama ángulo interior.

        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/gf_23.png" alt="" width="360" height="360">
        </div>
    </div>
