...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $respuesta_correcta = 'Rosita'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst visible">Las figuras no solo tienen lados.</div>
        <div class="inst">Se conforan de más partes.</div>
        <div class="inst">Ana tiene que saber el color del ángulo del pentágono.</div>
        <div class="inst">Para identificarlo la maestra le dijo: </div>
        <div class="inst">"Un ángulo es como la esquina del cruce de 2 lineas"</div>
        <div class="inst">¿De qué color es el ángulo en la figura?</div>
    ...
    <div>
        <img class="imgLecc" src="../../../assets/img/gf_23.jpg" alt="" width="360" height="360">
    </div>
