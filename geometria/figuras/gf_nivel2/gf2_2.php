...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
           El rectángulo esta pintado de dos colores. <br>
           La parte verde, se llama área, es la parte que ocupa una figura. <br>
           La parte roja son los lados/aristas, son las lineas que conforman a una figura.
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/gf_22.png" alt="" width="360" height="360">
        </div>
    </div>
