...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
           En el hexágono podemos obserbar un área de color morada. <br>
           Esa área se encuentra entre dos esquinas de la figura. <br>
           Pero esta por fuera de la figura. <br>
           Por ello se le conoce como ángulo externo.
           

        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/gf_24.png" alt="" width="360" height="360">
        </div>
    </div>
