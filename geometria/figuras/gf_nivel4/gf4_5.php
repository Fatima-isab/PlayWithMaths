...
if ($result->num_rows == 0) {
    ...
    header("location: gf4_4.php"); // Cambia "leccion_anterior_no_completada.php" por la página a la que quieras redireccionar
    exit;
}
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
          Tomando en cuanta lo aprendido anteriormente. <br>
          ¿Cuál es el área del rectangulo?
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/gf_45.png" alt="" width="360" height="360">
        </div>
    </div>

    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('1')">Ocho</button>
            <button class="boton" onclick="verificarRespuesta('2')">Quince</button>
            <button class="boton" onclick="verificarRespuesta('3')">Nueve</button>
        </div>
    </div>

    <div class="botones-container">
    <a href="../gf_nivel4/gf4_4.php">
