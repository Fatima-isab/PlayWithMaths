...
if ($result->num_rows == 0) {
    ...
    header("location: ../../../geometria/figuras/gf_nivel3/gf3_9.php");
    exit;
};
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
            Como se menciono en el nivel 2, al área es una
            propiedad de las figuras que se puede medir. <br>
            En este nivel vamos a aprender como calcular esa medida en
            los diferentes tipos de figuras.
        </div>
