...
if ($result->num_rows == 0) {
    ...
    header("location: gf4_7.php"); // Cambia "leccion_anterior_no_completada.php" por la página a la que quieras redireccionar
    exit;
}
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
          Cálcula el área del pentágono. <br>
          Recuerda las fórmulas vistas anteriormente. 
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/gf_48.png" alt="" width="360" height="360">
        </div>
    </div>

    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('1')">15</button>
            <button class="boton" onclick="verificarRespuesta('2')">6</button>
