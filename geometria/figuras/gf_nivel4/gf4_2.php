...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
          En la imagen se nos muestra como calcular el área de 
          los diferentes cuadrilateros. <br>
          Observa bien las fórmulas de cada figura, y cuando hayas 
          comprendido cada una presiona "He comprendido".
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/gf_42.jpg" alt="" width="360" height="360">
        </div>
    </div>
    ...
    <div class="botones-container">
    <a href="../gf_nivel4/gf4_1.php">
            <button class="boton boton-anterior">Anterior</button>
        </a>
        <a href="../gf_nivel4/gf4_3.php">
