...
if ($result->num_rows == 0) {
    ...
    header("location: gf4_6.php"); // Cambia "leccion_anterior_no_completada.php" por la página a la que quieras redireccionar
    exit;
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["respuesta"])) {
    ...
    $respuesta_correcta = '3'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
          Cálcula el área del triángulo. <br>
          Recuerda las fórmulas vistas anteriormente. 
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/gf_47.png" alt="" width="360" height="360">
        </div>
    </div>

    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('1')">9</button>
            <button class="boton" onclick="verificarRespuesta('2')">20</button>
            <button class="boton" onclick="verificarRespuesta('3')">10</button>
        </div>
    </div>

    <div class="botones-container">
    <a href="../gf_nivel4/gf4_6.php">
            <button class="boton boton-anterior">Anterior</button>
        </a>
        <a href="../gf_nivel4/gf4_8.php">
