...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
          ...
          los triángulos. <br>
          La fórmula es la misma para cada uno, solo cambia la forma de
          sacara las medidas de la altura.
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/gf_43.png"alt="" width="360" height="360">
        </div>
    </div>
