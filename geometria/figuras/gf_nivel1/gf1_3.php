...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
           Hay que seguir con los triángulos. <br>
           El azul tiene sus 3 lados iguales, es un equilátero<br>
           El rosita tiene 2 lados iguales, es un isóseles<br>
           El verde tiene un lado recto, es un rectángulo
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/gf_13.png" alt="" width="360" height="360">
        </div>
    </div>
