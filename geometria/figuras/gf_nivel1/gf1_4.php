...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $respuesta_correcta = 'Mario'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst visible">Ana y Mario estan sosteniendo una hoja.</div>
        <div class="inst">Cada uno tiene una figura diferente.</div>
        <div class="inst">¿Quién esta sosteniendo la figura que NO tiene lados?</div>
    ...
    <div>
        <img class="imgLecc" src="../../../assets/img/gf_14.jpg" alt="" width="360" height="360">
    </div>
