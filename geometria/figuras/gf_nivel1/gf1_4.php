...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
           Existen más figuras con más lados:<br>
           La verde tiene 5 lados, es un pentágono.<br>
           La naranja tiene 6 lados, es un hexágono.<br>
           La amarilla tiene 8 lados, es un octágono.
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/gf_14.png" alt="" width="360" height="360">
        </div>
    </div>
