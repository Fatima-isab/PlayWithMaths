...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
            Empecemos con los cuadrilateros. <br>
           El rojo tiene 4 lados iguales, es un cuadrado. <br>
           El amarillo tiene 2 lados igual, es un rectángulo. <br>
           El morado no tiene sus lados rectos, es un rombo. <br>
           El azul tiene dos lados paralelos, es un romboide.
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/gf_12.png" alt="" width="360" height="360">
        </div>
    </div>
