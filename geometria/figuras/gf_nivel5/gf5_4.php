...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
         Sacar el perímetro de un circulo puede ser un poco más complejo, 
         debido a que el circulo no cuenta con lados. <br>
         Para ello necesitamos de conocer el radio del circulo, 
         la fórmula a utilizar es= 2pi * radio. <br>
         Pi= 3.1416
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/gf_54.png" alt="" width="360" height="360">
        </div>
    </div>
