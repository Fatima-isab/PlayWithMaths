...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
          En el cuadrado se nos da la medida de 2 de sus lados. <br>
          Como el cuadrado tiene todos sus lados iguales podemos deducir
          que todos sus lados miden exactamente lo mismo. <br>
          Así que la suma de sus 4 lados da 20. <br>
          Por lo que el perímetro de este cuadrado es de 20cm.
