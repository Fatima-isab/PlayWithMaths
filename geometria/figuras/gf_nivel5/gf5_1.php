...
if ($result->num_rows == 0) {
    ...
    header("location: ../../../geometria/figuras/gf_nivel4/gf4_9.php");
    exit;
};
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
            Otra medida muy famosa que se puede obtener de las figura es
            el perímetro. <br>
            Esté se obtiene de una manera muy sencilla, simplemente es sumar
            los lados de las formas.
        </div>
