...
if ($result->num_rows == 0) {
    ...
    header("location: gf5_8.php"); // Cambia "gf1_5.php" por la página a la que quieras redireccionar
    exit;
}
...
<img src="../../../assets/img/gf_59.1.jpg" alt="" draggable="true" ondragstart="drag(event)" id="drag1">
<img src="../../../assets/img/gf_59.2.jpg" alt="" draggable="true" ondragstart="drag(event)" id="drag2">
<img src="../../../assets/img/gf_59.3.jpg" alt="" draggable="true" ondragstart="drag(event)" id="drag3">
