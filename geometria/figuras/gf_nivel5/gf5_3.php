...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
          En el rectángulo se nos da la medida de 2 de sus lados. <br>
          Como sabemos el rectángulo se conforma de 2 lados igual. <br>
          Así que podemos deducir que las medidas de los lados opuestos son las mismas<br>
          Por lo que el perímetro de este rectángulo es de 16cm.
    ...
    <div class="botones-container">
    <a href="../gf_nivel5/gf5_2.php">
            <button class="boton boton-anterior">Anterior</button>
        </a>
        <a href="../gf_nivel5/gf5_4.php">
