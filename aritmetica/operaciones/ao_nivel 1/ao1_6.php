...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        Si leemos un libro durante tres días de la siguiente manera. <br>
        El Lunes leímos 12 páginas, el martes 11, y hoy 17<br>
        ¿Cuántas páginas llevamos desde el Lunes hasta hoy?
        </div>
    ...
    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('40')">40</button>
            <button class="boton" onclick="verificarRespuesta('37')">37</button>
            <button class="boton" onclick="verificarRespuesta('47')">47</button>
        </div>
    </div>
