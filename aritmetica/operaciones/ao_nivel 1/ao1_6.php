...
<body>
    ...
    <div class="inst visible">A Samantha le encanta leer</div>
        <div class="inst">Está leyendo un libro de hadas</div>
        <div class="inst">El Lunes leyó 12 páginas, el martes 11, y hoy 17</div>
        <div class="inst">¿Cuántos páginas lleva desde el Lunes hasta hoy?</div>
    ...
    <div>
        <img class="imgLecc" src="../../../assets/img/leyendo.jpg" alt="" width="360" height="360">
    </div>
