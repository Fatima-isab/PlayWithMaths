...
<body>
    ...
    <div class="inst visible">Sofía y Alexis van al cine</div>
        <div class="inst">La película dura 2 horas y 15 minutos.</div>
        <div class="inst">Si comienza a las 3:50 de la tarde</div>
        <div class="inst">¿A qué hora terminará la película?</div>
    ...
    <div>
        <img class="imgLecc" src="../../../assets/img/cine.jpg" alt="" width="360" height="360">
    </div>
