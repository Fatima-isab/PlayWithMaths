...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["respuesta"])) {
    ...
    $respuesta_correcta = '45'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        Renata y Noemí piensan en 3 números que al sumarlos
        resulte un número secreto. <BR>
        En la imagen podemos ver los números que piensan
        ¿Cuál fue el número secreto?
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/dosninas.jpg" alt="" width="360" height="360">
        </div>
    </div>

    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('54')">54</button>
            <button class="boton" onclick="verificarRespuesta('45')">45</button>
            <button class="boton" onclick="verificarRespuesta('46')">46</button>
        </div>
    </div>
