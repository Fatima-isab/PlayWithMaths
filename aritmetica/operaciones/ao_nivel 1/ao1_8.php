...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["respuesta"])) {
    ...
    $respuesta_correcta = 'amarilla'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        Si hay tres canastas con pelotas ordenadas de la siguiente manera:<br>
        Canasta aul: 3 pelotas de futbol, 9 de basquetball, 8 de playa.<br>
        Canasta roja: 6 pelotas de futbol, 5 de basquetball, 8 de playa.<br>
        Canasta amarilla: 8 pelotas de futbol, 3 de basquetball, 12 de playa.<br>
        ¿Cuál canasta tiene más pelotas?
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/pelotas.jpg" alt="" width="360" height="360">
        </div>
    </div>

    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('azul')">Azul</button>
            <button class="boton" onclick="verificarRespuesta('roja')">Roja</button>
            <button class="boton" onclick="verificarRespuesta('amarilla')">Amarilla</button>
        </div>
    </div>
