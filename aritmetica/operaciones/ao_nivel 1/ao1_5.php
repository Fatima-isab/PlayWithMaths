...
<body>
    ...
    <div class="inst visible">El transporte escolar pasa a casa de varios alumnos</div>
        <div class="inst">Emma es la primera en subir, siempre sube a las 6:48 am</div>
        <div class="inst">Elías es el último en subir, y sube a las 7:56 am</div>
        <div class="inst">¿Cuántos minutos pasan entre las subidas de Emma y Elías ?</div>
    ...
    <div>
        <img class="imgLecc" src="../../../assets/img/bus.jpg" alt="" width="360" height="360">
    </div>
