...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["respuesta"])) {
    ...
    $respuesta_correcta = '7:56'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        El autobus comienza su recorrido a las 6:48 de la mañana
        y el recorrido dura 68 minutos<br>
        ¿A qué hora terminará el recorrido?
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/autobus.jpg" alt="" width="360" height="360">
        </div>
    </div>

    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('7:56')">7:56 am</button>
            <button class="boton" onclick="verificarRespuesta('7:55')">7:55 am</button>
            <button class="boton" onclick="verificarRespuesta('8:00')">8:00 am</button>
        </div>
    </div>
