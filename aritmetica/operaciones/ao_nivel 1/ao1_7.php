...
<body>
    ...
    <div class="inst visible">Renata y Noemí tienen un reto, se les da un número secreto</div>
        <div class="inst">Deben pensar 3 números que al sumarlos resulte ese número</div>
        <div class="inst">En la imagen podemos ver los números que piensan</div>
        <div class="inst">¿Cuál fue el número secreto que se les dio?</div>
