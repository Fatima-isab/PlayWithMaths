...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["respuesta"])) {
    ...
    $respuesta_correcta = '8:03'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
            El día de hoy el sol salió a las 7:02 am,<br>
            pasaron 13 horas y 1 minuto hasta<br> la puesta del sol. <br>
            ¿A qué hora se puso el sol hoy?
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/sol.jpg" alt="" width="360" height="360">
        </div>
    </div>

    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('8:03')">8:03 pm</button>
            <button class="boton" onclick="verificarRespuesta('7:03')">7:03 pm</button>
            <button class="boton" onclick="verificarRespuesta('6:03')">6:03 pm</button>
        </div>
    </div>
