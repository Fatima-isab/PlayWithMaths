...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        Marco necesita comprar una mochila y fue a la papelería.<br>
        Cuando llegó vio un balón que le gustó mucho.<br>
        Decidió comprar las dos cosas<br>
        ¿Cuánto dinero gastará Marco
        </div>
    ...
    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('600')">600</button>
            <button class="boton" onclick="verificarRespuesta('400')">400</button>
            <button class="boton" onclick="verificarRespuesta('800')">800</button>
        </div>
    </div>
