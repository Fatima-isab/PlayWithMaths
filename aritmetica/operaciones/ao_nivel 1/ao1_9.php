...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["respuesta"])) {
    ...
    $respuesta_correcta = '68'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        Si en la heladería los precios son:<br>
        Helado de fresa $25<br>
        Helado de chocolate $24<br>
        Helado de vainilla $19<br>
        ¿Cuánto se pagará si se compran los tres?
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/precio helados.jpg" alt="" width="360" height="360">
        </div>
    </div>

    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('68')">$68</button>
            <button class="boton" onclick="verificarRespuesta('69')">$69</button>
            <button class="boton" onclick="verificarRespuesta('86')">$86</button>
        </div>
    </div>

    <div class="botones-container">
    <a href="../ao_nivel 1/ao1_8.php">
