...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        El número 1 es el número multiplicativo neutro. <br>
        Esto significa que cualquier número multiplicado por 1 sigue siendo el mismo número.
            <br>
        </div>
