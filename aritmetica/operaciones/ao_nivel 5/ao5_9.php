...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        La tabla de multiplicar del 9 tiene un patrón interesante. <br>
        Los dígitos de los productos suman 9 <br>(9 x 1 = 9, 9 x 2 = 18, 1 + 8 = 9, etc.).<br>
         Además, en la tabla de 9, los números de la columna de las unidades descienden (9, 8, 7, etc.) y los de la columna de las decenas ascienden (0, 1, 2, etc.).
            <br>
        </div>
