...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        Para verificar si un número es múltiplo de 9, suma sus dígitos.<br>
        Si el resultado es 9 o múltiplo de 9, entonces el número original es múltiplo de 9.<br>
        Por ejemplo, 81 (8 + 1 = 9) es múltiplo de 9.
            <br>
        </div>
