...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        Los números primos son aquellos que solo pueden dividirse por 1 y por sí mismos.<br>
        Por ejemplo, 2, 3, 5 y 7 son números primos.<br>
