...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        El número 10 tiene muchos usos prácticos en la vida diaria.<br>
        Por ejemplo, tenemos 10 dedos en las manos, lo cual facilita contar en base 10.
            <br>
        </div>
