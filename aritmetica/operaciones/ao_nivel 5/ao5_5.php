...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        Los números cuadrados son el resultado de multiplicar un número por sí mismo.<br>
         Por ejemplo, 3 por 3 es igual a 9, así que 9 es un número cuadrado. 
         Otro ejemplo es 4 por 4 que es igual a 16.
            <br>
        </div>
