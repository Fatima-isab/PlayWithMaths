...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["respuesta"])) {
    ...
    $respuesta_correcta = '28'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        En una cafetería, prepararon un gran plato de postres para una fiesta. <br>
        Al comienzo, tenían 47 galletas alrededor del plato. Durante la fiesta, 
        los niños comieron 19 galletas. 
        ¿Cuántas galletas quedaron en el plato?
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/pamkk.jpg" alt="" width="360" height="360">
        </div>
    </div>

    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('28')">28</button>
            <button class="boton" onclick="verificarRespuesta('27')">27</button>
            <button class="boton" onclick="verificarRespuesta('30')">30</button>
        </div>
    </div>
