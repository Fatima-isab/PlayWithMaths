...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["respuesta"])) {
    ...
    $respuesta_correcta = '228'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        En un zoológico, había 325 animales, 97 de estos fueron trasladados a otro zoológico. <br>
        ¿Cuántos animales quedan en el zoológico?
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/globo.jfif" alt="" width="360" height="360">
        </div>
    </div>

    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('228')">228</button>
            <button class="boton" onclick="verificarRespuesta('220')">220</button>
            <button class="boton" onclick="verificarRespuesta('225')">225</button>
        </div>
    </div>
