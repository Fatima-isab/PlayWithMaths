...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["respuesta"])) {
    ...
    $respuesta_correcta = '163'; // Definir la respuesta correcta
...
<head>
    ...
    <title>La magia de multiplicar</title>
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        En una caja de juguetes había 220 bloques de construcción. 
        Después de un día de juego, se perdieron 57 bloques. <br>
        ¿Cuántos bloques quedan en la caja?
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/legos.jpg" alt="" width="360" height="360">
        </div>
    </div>

    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('160')">160</button>
            <button class="boton" onclick="verificarRespuesta('163')">163</button>
            <button class="boton" onclick="verificarRespuesta('173')">173</button>
        </div>
    </div>
