...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        Paola está esperando a su amiga Atziri,
        quien llegará a las 4:30 pm. <br>
        Cuando Paola ve el reloj, son las 3:42 pm<br>
        ¿Cuántos minutos faltan para que llegue Atziri?
        </div>
    ...
    <div class="botones-container">
        <div id="botones">
            ...
            <button class="boton" onclick="verificarRespuesta('42')">42</button>
        </div>
    </div>
