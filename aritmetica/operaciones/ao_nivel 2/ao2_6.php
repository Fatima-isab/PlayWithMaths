...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["respuesta"])) {
    ...
    $respuesta_correcta = '18'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        En un torneo de fútbol, un equipo tenía 30 balones. 
        Durante el primer partido perdieron 7 balones, durante el segundo partido perdieron 5 balones.<br>
        ¿Cuántos balones le quedan al equipo al final del día?
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/cancha fubol.jpg" alt="" width="360" height="360">
        </div>
    </div>

    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('18')">18</button>
            <button class="boton" onclick="verificarRespuesta('12')">12</button>
            <button class="boton" onclick="verificarRespuesta('21')">21</button>
        </div>
    </div>
