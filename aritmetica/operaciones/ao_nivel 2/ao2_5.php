...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["respuesta"])) {
    ...
    $respuesta_correcta = '7'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        En un jardín, hay tres flores.
        La flor más alta mide 82 cm, la flor del medio mide 75 cm y la más peqeña 63 cm. 
        ¿Cuánta distancia hay entre las flores que tienen menos distancia entre sí?
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/flores.jpg" alt="" width="360" height="360">
        </div>
    </div>

    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('5')">5 cm</button>
            <button class="boton" onclick="verificarRespuesta('7')">7 cm</button>
            <button class="boton" onclick="verificarRespuesta('12')">12 cm</button>
        </div>
    </div>
