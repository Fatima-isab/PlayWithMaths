...
$query_verificar_completada = "SELECT * FROM lecciones_completadas WHERE id_usuario = $id_usuario AND id_leccion = '201'";
...
$query_verificar_completada2 = "SELECT * FROM lecciones_completadas WHERE id_usuario = $id_usuario AND id_leccion = '202'";
...
$query_verificar_completada3 = "SELECT * FROM lecciones_completadas WHERE id_usuario = $id_usuario AND id_leccion = '203'";
...
$query_verificar_completada4 = "SELECT * FROM lecciones_completadas WHERE id_usuario = $id_usuario AND id_leccion = '204'";
...
$query_verificar_completada5 = "SELECT * FROM lecciones_completadas WHERE id_usuario = $id_usuario AND id_leccion = '205'";
...
$query_verificar_completada6 = "SELECT * FROM lecciones_completadas WHERE id_usuario = $id_usuario AND id_leccion = '206'";
...
$query_verificar_completada7 = "SELECT * FROM lecciones_completadas WHERE id_usuario = $id_usuario AND id_leccion = '207'";
...
$query_verificar_completada8 = "SELECT * FROM lecciones_completadas WHERE id_usuario = $id_usuario AND id_leccion = '208'";
...
$query_verificar_completada9 = "SELECT * FROM lecciones_completadas WHERE id_usuario = $id_usuario AND id_leccion = '209'";
...
<body>
    <div class="arriba">
        ...
        <h2 class="titlesub">División misteriosa</h2>
    </div>

    <div class="circle-container">
        <a href="./ao_nivel 4/ao4_1.php">
            <div class="circle1"><span>1</span></div>
        </a>
        <a href="./ao_nivel 4/ao4_2.php">
