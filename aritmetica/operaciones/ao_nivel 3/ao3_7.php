...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["respuesta"])) {
    ...
    $respuesta_correcta = '360'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        En una biblioteca, 
        cada estante tiene 18 libros.<br>
        Si hay 20 estantes, <br>
        ¿Cuántos libros hay en total?
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/estante.jpg" alt="" width="360" height="360">
        </div>
    </div>

    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('360')">360</button>
            <button class="boton" onclick="verificarRespuesta('400')">400</button></button>
            <button class="boton" onclick="verificarRespuesta('390')">390</button>
        </div>
    </div>
