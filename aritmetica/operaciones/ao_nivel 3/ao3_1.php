...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
            En este módulo pondremos en práctica la multiplicación<br>
            La multiplicación es una operación matemática que consiste en calcular el total de un número sumado a sí mismo varias veces.
            <br>
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/multiplicacion.jpg" alt="" width="360" height="360">
        </div>
    </div>
