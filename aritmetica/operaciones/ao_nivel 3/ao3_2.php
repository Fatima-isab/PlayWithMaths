...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        Decir 3 x 4 es como decir "3 veces 4"
        Si tenemos 3 cajas, y en cada caja hay 4 chcolates
        Tenemos 3 veces 4 chocolates, en total son 12
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/4x3.jpg" alt="" width="360" height="360">
        </div>
    </div>
