...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["respuesta"])) {
    ...
    $respuesta_correcta = '3x5'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        Daniela y sus amigos salieron al parque,
        encontraron a un vendedor de globos,
        Cada uno de los 5 niños compró 3 globos.<br>
        ¿Cómo se puede representar esto?
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/globos3.jpg" alt="" width="360" height="360">
        </div>
    </div>

    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('3x5')">3x5</button>
            <button class="boton" onclick="verificarRespuesta('3x3')">3x3</button></button>
            <button class="boton" onclick="verificarRespuesta('5x5')">5x5</button>
        </div>
    </div>
