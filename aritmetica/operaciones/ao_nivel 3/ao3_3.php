...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
       Aquí podemos ver la tabla pitagórica. <br>
       Esta tabla permite concocer el resultado de una multiplicación simple o tabla de multiplicar,
       solo debes buscar dos números y ver donde se intersecan.
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/cuadro de multiplicar.png" alt="" width="360" height="360">
        </div>
    </div>
