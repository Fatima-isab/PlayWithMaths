...
<body>
    ...
    <div class="contenedor">
        <div class="inst visible">Decir 3 x 4 es como decir "3 veces 4"</div>
        <div class="inst">Si tenemos 3 cajas, y en cada caja hay 4 chcolates</div>
        <div class="inst">Tenemos 3 veces 4 chocolates, en total son 12</div>
    ...
    <div>
        <img class="imgLecc" src="../../../assets/img/4x3.jpg" width="360" height="360">
    </div>
