...
<body>
    ...
    <div class="contenedor">
        <div class="inst visible">Este es un cuadro de multiplicación,</div>
        <div class="inst">tiene los primeros 10 números, pues son los más comunes.</div>
        <div class="inst">Pero si te interesa, puedes encontrar más grandes</div>
        <div class="inst">No olvides seguir aprendiendo</div>
    ...
    <div>
        <img class="imgLecc" src="../../../assets/img/cuadro de multiplicar.png" width="360" height="360">
    </div>
