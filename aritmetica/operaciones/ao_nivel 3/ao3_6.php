...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["respuesta"])) {
    ...
    $respuesta_correcta = '1120'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        En una pastelería, cada caja de galletas contiene 16 piezas.
        Si hay 70 cajas,<br>
        ¿cuántas galletas hay en total?
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/galletas.jpg" alt="" width="360" height="360">
        </div>
    </div>

    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('1050')">1050</button>
            <button class="boton" onclick="verificarRespuesta('1120')">1120</button></button>
            <button class="boton" onclick="verificarRespuesta('1400')">1400</button>
        </div>
    </div>
