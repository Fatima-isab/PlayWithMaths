...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["respuesta"])) {
    ...
    $respuesta_correcta = '48'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        En un parque, hay 12 juegos y cada juego tiene espacio para 4 personas.<br>
         ¿Cuántas personas pueden subirse a los juegos en total?
        </div>
    ...
    <div class="botones-container">
        <div id="botones">
            ...
            <button class="boton" onclick="verificarRespuesta('36')">36</button>
        </div>
    </div>
