...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["respuesta"])) {
    ...
    $respuesta_correcta = '120'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        Un pastelero trabaja 5 días en una semana,
        hace 6 pasteles cada día. 
        ¿Cuántos pasteles hará en 4 semanas?
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/panaderia.jpg" alt="" width="360" height="360">
        </div>
    </div>

    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('44')">44</button>
            <button class="boton" onclick="verificarRespuesta('50')">50</button></button>
            <button class="boton" onclick="verificarRespuesta('120')">120</button>
        </div>
    </div>
