...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        Una panadería hace 920 panes en un día y los coloca en bandejas con 12 panes cada una.<br>
        ¿Cuántos panes quedan fuera de las bandejas?
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/gallets.jpg" alt="" width="360" height="360">
        </div>
    </div>
