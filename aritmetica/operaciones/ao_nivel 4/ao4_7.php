...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["respuesta"])) {
    ...
    $respuesta_correcta = '64'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        Una fábrica produce 1024 botellas de agua en una semana. 
        Si cada caja contiene 16 botellas.
        ¿Cuántas cajas se pueden llenar?
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/cajas.jpg" alt="" width="360" height="360">
        </div>
    </div>

    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('48')">48</button>
            <button class="boton" onclick="verificarRespuesta('52')">52</button></button>
            <button class="boton" onclick="verificarRespuesta('64')">64</button>
        </div>
    </div>
