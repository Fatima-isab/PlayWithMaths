...
<body>
    ...
    <div class="contenedor">
        <div class="inst visible">David, Hugo y Felipe construyeron un tren </div>
        <div class="inst">el tren tiene tres vagones,</div>
        <div class="inst">cada vagón necesita 8 ruedas para avanzar,</div>
        <div class="inst">¿Cuántas ruedas necesitan conseguir?</div>
    ...
    <div>
        <img class="imgLecc" src="../../../assets/img/trenecito.jpg" alt="" width="360" height="360">
    </div>
