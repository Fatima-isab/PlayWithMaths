...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["respuesta"])) {
    ...
    $respuesta_correcta = '13'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        Hay 936 páginas en un libro y Juan quiere leerlo en  72 días, leyendo la misma cantidad de páginas cada día.<br>
        ¿Cuántas páginas debe leer Juan cada día?
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/libros.jpg" alt="" width="360" height="360">
        </div>
    </div>

    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('13')">13</button>
            <button class="boton" onclick="verificarRespuesta('15')">15</button></button>
            <button class="boton" onclick="verificarRespuesta('17')">17</button>
        </div>
    </div>
