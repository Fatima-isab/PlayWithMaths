...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $respuesta_correcta = '640'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst visible">Héctor alimentará a los perros de su abuela por 4 días,</div>
        <div class="inst">la abuela tiene 6 perros,</div>
        <div class="inst">la cantidad de comida para cada perro es de 110 gramos,</div>
        <div class="inst">Héctor cuenta con 2 kilos de alimento,</div>
        <div class="inst">¿Cuántos gramos de comida le hacen falta?</div>
    ...
    <div>
        <img class="imgLecc" src="../../../assets/img/perros.jpg" alt="" width="360" height="360">
    </div>
