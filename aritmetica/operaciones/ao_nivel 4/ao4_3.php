...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        Si repartimos 25 juguetes entre 4 niños, de forma que a todos les toque la misma cantidad. <br>
        ¿Cuántos juguetes sobran?
        </div>
    ...
    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('1')">1</button>
