...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $respuesta_correcta = '126'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst visible">Ayer por la tarde, Lia, Mónica y Óscar fueron por helado,</div>
        <div class="inst">cada bola de helado costó $14 pesos,</div>
        <div class="inst">Óscar pidió 3 bolas, Mónica 4, y Lia 2.</div>
        <div class="inst">¿Cuánto pagaron el total?</div>
    ...
    <div>
        <img class="imgLecc" src="../../../assets/img/helado.jpg" alt="" width="360" height="360">
    </div>
