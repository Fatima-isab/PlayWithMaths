...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["respuesta"])) {
    ...
    $respuesta_correcta = '27'; // Definir la respuesta correcta
...
<body>
    <h1>División misteriosa</h1>

    <div class="contenedor">
        <div class="inst">
        En una escuela primaria tienen 675 estudiantes, y se quiere formar grupos de 25 estudiantes para una excursión.<br>
        ¿Cuántos grupos completos se pueden formar?
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/escuela.jpg" alt="" width="360" height="360">
        </div>
    </div>

    <div class="botones-container">
        <div id="botones">
            <button class="boton" onclick="verificarRespuesta('27')">27</button>
            <button class="boton" onclick="verificarRespuesta('25')">25</button></button>
            <button class="boton" onclick="verificarRespuesta('24')">24</button>
        </div>
    </div>
