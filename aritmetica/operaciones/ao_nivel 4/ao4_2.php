...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["respuesta"])) {
    ...
    $respuesta_correcta = '6'; // Definir la respuesta correcta
...
<body>
    ...
    <div class="contenedor">
        <div class="inst">
        Un grupo de 30 alumnos se divide en equipos de 5 personas cada uno.<br>
         ¿Cuántos equipos se formarán?
        </div>

        <div class="img-container">
            <img class="imgLecc" src="../../../assets/img/salon.jpg" alt="" width="360" height="360">
        </div>
    </div>
    ...
    <div class="botones-container">
        <div id="botones">
            ...
            <button class="boton" onclick="verificarRespuesta('5')">5</button></button>
            <button class="boton" onclick="verificarRespuesta('6')">6</button>
        </div>
    </div>
